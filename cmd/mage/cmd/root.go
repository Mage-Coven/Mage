...
import (
	...
	mageclient "github.com/mage-coven/mage/client"
	"github.com/mage-coven/mage/migrate"
)

// EnvPrefix is the prefix environment variables must have to configure the app.
const EnvPrefix = "MAGE"

// NewRootCmd creates a new root command for the mage blockchain.
...
// addSubCmds registers all the sub commands used by mage.
