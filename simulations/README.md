...
>e.g. `mage/mage-sim:version1`, `go test ./app`
...
- create and submit a new array job (based of the job definition) with
  - image `mage/mage-sim:<some-version>`
...
- any changes needed to the code or script necessitates a rebuild:
  - `docker build -f simulations/Dockerfile -t mage/mage-sim:<some-version> .`
  - `docker push mage/mage-sim:<some-version>`
