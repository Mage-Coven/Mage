...
func (suite *keeperTestSuite) TestDeposit_CreatePool_PoolNotAllowed() {
	...
	amountA := sdk.NewCoin("umage", sdk.NewInt(10e6))
	amountB := sdk.NewCoin("fusd", sdk.NewInt(50e6))

	err := suite.Keeper.Deposit(suite.Ctx, depositor.GetAddress(), amountA, amountB, sdk.MustNewDecFromStr("0.01"))
	suite.Require().EqualError(err, "can not create pool 'umage:fusd': not allowed")
}
...
func (suite *keeperTestSuite) TestDeposit_InsufficientFunds() {
	testCases := []struct {
	...
	}{
		{
			...
			depositA: sdk.NewCoin("umage", sdk.NewInt(100)),
			depositB: sdk.NewCoin("fusd", sdk.NewInt(100)),
		},
		{
			name:     "low balance",
			balanceA: sdk.NewCoin("umage", sdk.NewInt(1000000)),
			balanceB: sdk.NewCoin("fusd", sdk.NewInt(1000000)),
			depositA: sdk.NewCoin("umage", sdk.NewInt(1000001)),
			depositB: sdk.NewCoin("fusd", sdk.NewInt(10000001)),
		},
		{
			name:     "large balance difference",
			balanceA: sdk.NewCoin("umage", sdk.NewInt(100e6)),
			balanceB: sdk.NewCoin("fusd", sdk.NewInt(500e6)),
			depositA: sdk.NewCoin("umage", sdk.NewInt(1000e6)),
			depositB: sdk.NewCoin("fusd", sdk.NewInt(5000e6)),
		},
	}
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			err = suite.CreatePool(sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(10e6)), sdk.NewCoin("fusd", sdk.NewInt(50e6))))
...
func (suite *keeperTestSuite) TestDeposit_InsufficientFunds_Vesting() {
	testCases := []struct {
	...
	}{
		{
			...
			balanceA: sdk.NewCoin("umage", sdk.ZeroInt()),
			balanceB: sdk.NewCoin("fusd", sdk.ZeroInt()),
			vestingA: sdk.NewCoin("umage", sdk.NewInt(100)),
			vestingB: sdk.NewCoin("fusd", sdk.NewInt(100)),
			depositA: sdk.NewCoin("umage", sdk.NewInt(100)),
			depositB: sdk.NewCoin("fusd", sdk.NewInt(100)),
		},
		{
			...
			balanceA: sdk.NewCoin("umage", sdk.NewInt(1000000)),
			balanceB: sdk.NewCoin("fusd", sdk.NewInt(1000000)),
			vestingA: sdk.NewCoin("umage", sdk.NewInt(1)),
			vestingB: sdk.NewCoin("fusd", sdk.NewInt(1)),
			depositA: sdk.NewCoin("umage", sdk.NewInt(1000001)),
			depositB: sdk.NewCoin("fusd", sdk.NewInt(10000001)),
		},
		{
			...
			balanceA: sdk.NewCoin("umage", sdk.NewInt(100e6)),
			balanceB: sdk.NewCoin("fusd", sdk.NewInt(500e6)),
			vestingA: sdk.NewCoin("umage", sdk.NewInt(1000e6)),
			vestingB: sdk.NewCoin("fusd", sdk.NewInt(5000e6)),
			depositA: sdk.NewCoin("umage", sdk.NewInt(1000e6)),
			depositB: sdk.NewCoin("fusd", sdk.NewInt(5000e6)),
		},
	}
...
func (suite *keeperTestSuite) TestDeposit_CreatePool() {
	pool := types.NewAllowedPool("umage", "fusd")
	suite.Require().NoError(pool.Validate())
	suite.Keeper.SetParams(suite.Ctx, types.NewParams(types.NewAllowedPools(pool), types.DefaultSwapFee))
...
func (suite *keeperTestSuite) TestDeposit_PoolExists() {
	...
	balance := sdk.NewCoins(
		sdk.NewCoin("umage", sdk.NewInt(5e6)),
	...
	depositA := sdk.NewCoin("fusd", balance.AmountOf("fusd"))
	depositB := sdk.NewCoin("umage", balance.AmountOf("umage"))
	...
	expectedShareValue := sdk.NewCoins(
		sdk.NewCoin("umage", sdk.NewInt(999999)),
		sdk.NewCoin("fusd", sdk.NewInt(4999998)),
	)
...
func (suite *keeperTestSuite) TestDeposit_MultipleDeposit() {
	fundsToDeposit := sdk.NewCoins(
		sdk.NewCoin("umage", sdk.NewInt(5e6)),
		sdk.NewCoin("fusd", sdk.NewInt(25e6)),
	)
	...
	depositA := sdk.NewCoin("fusd", fundsToDeposit.AmountOf("fusd"))
	depositB := sdk.NewCoin("umage", fundsToDeposit.AmountOf("umage"))
...
func (suite *keeperTestSuite) TestDeposit_Slippage() {
	...
	testCases := []struct {
		...
		{sdk.NewCoin("fusd", sdk.NewInt(5e6)), sdk.NewCoin("umage", sdk.NewInt(5e6)), sdk.MustNewDecFromStr("0.7"), true},
		{sdk.NewCoin("fusd", sdk.NewInt(5e6)), sdk.NewCoin("umage", sdk.NewInt(5e6)), sdk.MustNewDecFromStr("0.8"), true},
		{sdk.NewCoin("umage", sdk.NewInt(5e6)), sdk.NewCoin("fusd", sdk.NewInt(5e6)), sdk.MustNewDecFromStr("3"), true},
		{sdk.NewCoin("umage", sdk.NewInt(5e6)), sdk.NewCoin("fusd", sdk.NewInt(5e6)), sdk.MustNewDecFromStr("4"), false},
		{sdk.NewCoin("umage", sdk.NewInt(1e6)), sdk.NewCoin("fusd", sdk.NewInt(5e6)), sdk.MustNewDecFromStr("0"), false},
		{sdk.NewCoin("umage", sdk.NewInt(1e6)), sdk.NewCoin("fusd", sdk.NewInt(4e6)), sdk.MustNewDecFromStr("0.25"), false},
		{sdk.NewCoin("umage", sdk.NewInt(1e6)), sdk.NewCoin("fusd", sdk.NewInt(4e6)), sdk.MustNewDecFromStr("0.2"), true},
	}
...
func (suite *keeperTestSuite) TestDeposit_InsufficientLiquidity() {
	testCases := []struct {
		...
		{sdk.NewCoin("umage", sdk.NewInt(10e6)), sdk.NewCoin("fusd", sdk.NewInt(50e6)), sdk.NewInt(40e6), sdk.NewCoin("umage", sdk.NewInt(1)), sdk.NewCoin("fusd", sdk.NewInt(1))},
		// test share value rounding to zero
		{sdk.NewCoin("umage", sdk.NewInt(10e6)), sdk.NewCoin("fusd", sdk.NewInt(10e6)), sdk.NewInt(100), sdk.NewCoin("umage", sdk.NewInt(1000)), sdk.NewCoin("fusd", sdk.NewInt(1000))},
	}
	...
	for _, tc := range testCases {
		suite.Run(fmt.Sprintf("depositA=%s depositB=%s", tc.depositA, tc.depositB), func() {
			...
			record := types.PoolRecord{
				PoolID:      types.PoolID("umage", "fusd"),
				ReservesA:   tc.poolA,
				ReservesB:   tc.poolB,
