...
//
// For example, if we have a pool with 100e6 umage and 400e6 fusd.  The umage price is 4 fusd and the
// fusd price is 0.25 umage.  If a depositor adds liquidity of 4e6 umage and 14e6 fusd, a mage price of
// 3.50 fusd and a fusd price of 0.29 umage.  This is a -12.5% slippage is the umage price, and a 14.3%
// slippage in the fusd price.
//
