...
func DefaultGenesisState() GenesisState {
	return GenesisState{
		...
		FUSDMintingClaims:           DefaultFUSDClaims,
...
func (gs GenesisState) Validate() error {
	...
	if err := gs.FUSDRewardState.Validate(); err != nil {
		return err
	}
	...
	if err := gs.FUSDMintingClaims.Validate(); err != nil {
		return err
	}
