...
// source: mage/incentive/v1beta1/params.proto
...
// Params
type Params struct {
	FUSDMintingRewardPeriods RewardPeriods           `protobuf:"bytes,1,rep,name=fusd_minting_reward_periods,json=fusdMintingRewardPeriods,proto3,castrepeated=RewardPeriods" json:"fusd_minting_reward_periods"`
...
func init() {
	proto.RegisterType((*RewardPeriod)(nil), "mage.incentive.v1beta1.RewardPeriod")
	proto.RegisterType((*MultiRewardPeriod)(nil), "mage.incentive.v1beta1.MultiRewardPeriod")
	proto.RegisterType((*TypedMultiRewardPeriod)(nil), "mage.incentive.v1beta1.TypedMultiRewardPeriod")
	proto.RegisterType((*Multiplier)(nil), "mage.incentive.v1beta1.Multiplier")
	proto.RegisterType((*MultipliersPerDenom)(nil), "mage.incentive.v1beta1.MultipliersPerDenom")
	proto.RegisterType((*Params)(nil), "mage.incentive.v1beta1.Params")
}

func init() {
	proto.RegisterFile("mage/incentive/v1beta1/params.proto", fileDescriptor_bb8833f5d745eac9)
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FUSDMintingRewardPeriods) > 0 {
		for iNdEx := len(m.FUSDMintingRewardPeriods) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.FUSDMintingRewardPeriods[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Params) Size() (n int) {
	...
	_ = l
	if len(m.FUSDMintingRewardPeriods) > 0 {
		for _, e := range m.FUSDMintingRewardPeriods {
			l = e.Size()
			n += 1 + l + sovParams(uint64(l))
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FUSDMintingRewardPeriods", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FUSDMintingRewardPeriods = append(m.FUSDMintingRewardPeriods, RewardPeriod{})
			if err := m.FUSDMintingRewardPeriods[len(m.FUSDMintingRewardPeriods)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
