...
// source: mage/incentive/v1beta1/genesis.proto
...
type GenesisState struct {
	...
	FUSDMintingClaims           FUSDMintingClaims           `protobuf:"bytes,7,rep,name=fusd_minting_claims,json=fusdMintingClaims,proto3,castrepeated=FUSDMintingClaims" json:"fusd_minting_claims"`
...
func init() {
	proto.RegisterType((*AccumulationTime)(nil), "mage.incentive.v1beta1.AccumulationTime")
	proto.RegisterType((*AccrualTime)(nil), "mage.incentive.v1beta1.AccrualTime")
	proto.RegisterType((*GenesisRewardState)(nil), "mage.incentive.v1beta1.GenesisRewardState")
	proto.RegisterType((*GenesisState)(nil), "mage.incentive.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("mage/incentive/v1beta1/genesis.proto", fileDescriptor_8b76737885d05afd)
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FUSDMintingClaims) > 0 {
		for iNdEx := len(m.FUSDMintingClaims) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.FUSDMintingClaims[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	dAtA[i] = 0x1a
	{
		size, err := m.FUSDRewardState.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	n += 1 + l + sovGenesis(uint64(l))
	if len(m.FUSDMintingClaims) > 0 {
		for _, e := range m.FUSDMintingClaims {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FUSDRewardState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FUSDRewardState.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FUSDMintingClaims", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FUSDMintingClaims = append(m.FUSDMintingClaims, FUSDMintingClaim{})
			if err := m.FUSDMintingClaims[len(m.FUSDMintingClaims)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
