...
// source: mage/incentive/v1beta1/claims.proto
...
type TypedRewardIndexes struct {
	ClaimType      ClaimType     `protobuf:"varint,1,opt,name=claim_type,json=claimType,proto3,enum=mage.incentive.v1beta1.ClaimType" json:"claim_type,omitempty"`
...
func (m *FUSDMintingClaim) Reset()         { *m = FUSDMintingClaim{} }
func (m *FUSDMintingClaim) String() string { return proto.CompactTextString(m) }
...
func (m *FUSDMintingClaim) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FUSDMintingClaim.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FUSDMintingClaim) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FUSDMintingClaim.Merge(m, src)
}
func (m *FUSDMintingClaim) XXX_Size() int {
	return m.Size()
}
func (m *FUSDMintingClaim) XXX_DiscardUnknown() {
	xxx_messageInfo_FUSDMintingClaim.DiscardUnknown(m)
}

var xxx_messageInfo_FUSDMintingClaim proto.InternalMessageInfo
...
func init() {
	proto.RegisterEnum("mage.incentive.v1beta1.ClaimType", ClaimType_name, ClaimType_value)
	proto.RegisterType((*BaseClaim)(nil), "mage.incentive.v1beta1.BaseClaim")
	proto.RegisterType((*BaseMultiClaim)(nil), "mage.incentive.v1beta1.BaseMultiClaim")
	proto.RegisterType((*RewardIndex)(nil), "mage.incentive.v1beta1.RewardIndex")
	proto.RegisterType((*RewardIndexesProto)(nil), "mage.incentive.v1beta1.RewardIndexesProto")
	proto.RegisterType((*TypedRewardIndexes)(nil), "mage.incentive.v1beta1.TypedRewardIndexes")
	proto.RegisterType((*MultiRewardIndex)(nil), "mage.incentive.v1beta1.MultiRewardIndex")
	proto.RegisterType((*MultiRewardIndexesProto)(nil), "mage.incentive.v1beta1.MultiRewardIndexesProto")
	proto.RegisterType((*FUSDMintingClaim)(nil), "mage.incentive.v1beta1.FUSDMintingClaim")
	proto.RegisterType((*HardLiquidityProviderClaim)(nil), "mage.incentive.v1beta1.HardLiquidityProviderClaim")
	proto.RegisterType((*DelegatorClaim)(nil), "mage.incentive.v1beta1.DelegatorClaim")
	proto.RegisterType((*SwapClaim)(nil), "mage.incentive.v1beta1.SwapClaim")
	proto.RegisterType((*SavingsClaim)(nil), "mage.incentive.v1beta1.SavingsClaim")
	proto.RegisterType((*EarnClaim)(nil), "mage.incentive.v1beta1.EarnClaim")
	proto.RegisterType((*Claim)(nil), "mage.incentive.v1beta1.Claim")
}

func init() {
	proto.RegisterFile("mage/incentive/v1beta1/claims.proto", fileDescriptor_5f7515029623a895)
}
...
func (m *FUSDMintingClaim) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FUSDMintingClaim: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FUSDMintingClaim: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
