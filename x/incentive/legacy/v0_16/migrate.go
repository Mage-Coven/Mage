...
func migrateParams(params v015incentive.Params) v016incentive.Params {
	return v016incentive.Params{
		FUSDMintingRewardPeriods: migrateRewardPeriods(params.FUSDMintingRewardPeriods),
...
func migrateFUSDMintingClaims(oldClaims v015incentive.FUSDMintingClaims) v016incentive.FUSDMintingClaims {
	claims := make(v016incentive.FUSDMintingClaims, len(oldClaims))
	for i, oldClaim := range oldClaims {
		claims[i] = v016incentive.FUSDMintingClaim{
...
func Migrate(oldState v015incentive.GenesisState) *v016incentive.GenesisState {
	return &v016incentive.GenesisState{
		...
		FUSDRewardState:             migrateRewardState(oldState.FUSDRewardState),
		...
		FUSDMintingClaims:           migrateFUSDMintingClaims(oldState.FUSDMintingClaims),
