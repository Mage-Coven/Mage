...
// source: mage/bep3/v1beta1/bep3.proto
...
const (
	...
	// SWAP_DIRECTION_INCOMING represents is incoming swap (to the mage chain)
	SWAP_DIRECTION_INCOMING SwapDirection = 1
	// SWAP_DIRECTION_OUTGOING represents an outgoing swap (from the mage chain)
...
type AssetParam struct {
	...
	// deputy_address the mage address of the deputy
...
type AtomicSwap struct {
	...
	Status SwapStatus `protobuf:"varint,10,opt,name=status,proto3,enum=mage.bep3.v1beta1.SwapStatus" json:"status,omitempty"`
	...
	Direction SwapDirection `protobuf:"varint,12,opt,name=direction,proto3,enum=mage.bep3.v1beta1.SwapDirection" json:"direction,omitempty"`
}
...
func init() {
	proto.RegisterEnum("mage.bep3.v1beta1.SwapStatus", SwapStatus_name, SwapStatus_value)
	proto.RegisterEnum("mage.bep3.v1beta1.SwapDirection", SwapDirection_name, SwapDirection_value)
	proto.RegisterType((*Params)(nil), "mage.bep3.v1beta1.Params")
	proto.RegisterType((*AssetParam)(nil), "mage.bep3.v1beta1.AssetParam")
	proto.RegisterType((*SupplyLimit)(nil), "mage.bep3.v1beta1.SupplyLimit")
	proto.RegisterType((*AtomicSwap)(nil), "mage.bep3.v1beta1.AtomicSwap")
	proto.RegisterType((*AssetSupply)(nil), "mage.bep3.v1beta1.AssetSupply")
}

func init() { proto.RegisterFile("mage/bep3/v1beta1/bep3.proto", fileDescriptor_01a01937d931b013) }
