...
// 	// hacky way to give accounts coins so they can create cdps (coins  includes fusd so it's possible to have sufficient balance to close a cdp)
...
// 			sdk.NewCoin("fusd", sdk.NewInt(int64(simState.Rand.Intn(1000000000)))),
...
// 						DebtLimit:           sdk.NewInt64Coin("fusd", 20000000000000),
...
// 						DebtLimit:           sdk.NewInt64Coin("fusd", 30000000000000),
...
// 						Type:                "bnb-a",
// 						LiquidationRatio:    sdk.MustNewDecFromStr("1.5"),
// 						DebtLimit:           sdk.NewInt64Coin("fusd", 100000000000000),
// 						StabilityFee:        sdk.MustNewDecFromStr("1.000000002293273137"),
// 						LiquidationPenalty:  sdk.MustNewDecFromStr("0.075"),
