...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&CommunityPoolDepositProposal{}, "mage/CommunityPoolDepositProposal", nil)
	cdc.RegisterConcrete(&CommunityPoolWithdrawProposal{}, "mage/CommunityPoolWithdrawProposal", nil)
}
