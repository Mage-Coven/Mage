...
// source: mage/magemint/v1beta1/magemint.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "mage.magemint.v1beta1.Params")
}

func init() {
	proto.RegisterFile("mage/magemint/v1beta1/magemint.proto", fileDescriptor_bdfe36d50f127f04)
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		...
		i = encodeVarintMagemint(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x12
	{
...
func encodeVarintMagemint(dAtA []byte, offset int, v uint64) int {
	offset -= sovMagemint(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovMagemint(uint64(l))
	l = m.StakingRewardsApy.Size()
	n += 1 + l + sovMagemint(uint64(l))
	return n
}

func sovMagemint(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozMagemint(x uint64) (n int) {
	return sovMagemint(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthMagemint
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipMagemint(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipMagemint(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowMagemint
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthMagemint
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupMagemint
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthMagemint        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowMagemint          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupMagemint = fmt.Errorf("proto: unexpected end of group")
)
