...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(CommitteeChangeProposal{}, "mage/CommitteeChangeProposal")

	govtypes.RegisterProposalType(ProposalTypeCommitteeDelete)
	govtypes.RegisterProposalTypeCodec(CommitteeDeleteProposal{}, "mage/CommitteeDeleteProposal")
}
