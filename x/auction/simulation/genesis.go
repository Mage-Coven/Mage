...
func RandomizedGenState(simState *module.SimulationState) {
	...
	bidderCoins := sdk.NewCoins(sdk.NewInt64Coin("fusd", 10000000000))
	...
	// - it just mints mage, doesn't need a starting balance
