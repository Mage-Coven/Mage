...
// source: mage/auction/v1beta1/auction.proto
...
func init() {
	proto.RegisterType((*BaseAuction)(nil), "mage.auction.v1beta1.BaseAuction")
	proto.RegisterType((*SurplusAuction)(nil), "mage.auction.v1beta1.SurplusAuction")
	proto.RegisterType((*DebtAuction)(nil), "mage.auction.v1beta1.DebtAuction")
	proto.RegisterType((*CollateralAuction)(nil), "mage.auction.v1beta1.CollateralAuction")
	proto.RegisterType((*WeightedAddresses)(nil), "mage.auction.v1beta1.WeightedAddresses")
}

func init() {
	proto.RegisterFile("mage/auction/v1beta1/auction.proto", fileDescriptor_b9b5dac2c776ef9e)
}
