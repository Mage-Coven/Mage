	...
	testCases := []borrowTest{
		{
			...
			args{
				...
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF)), sdk.NewCoin("fusd", sdk.NewInt(1000*FUSD_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(10*MAGE_CF))),
			},
			errArgs{
				expectPass:   true,
				expectDelete: false,
		...
		},
		{
			...
			args{
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
			},
			errArgs{
				expectPass:   true,
				expectDelete: true,
		...
		},
		{
			...
			args{
				...
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF)), sdk.NewCoin("fusd", sdk.NewInt(1000*FUSD_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(80*MAGE_CF))), // Deposit less so user still has some MAGE
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(60*MAGE_CF))), // Exceeds borrowed coins but not user's balance
			},
			errArgs{
				expectPass:   true,
				expectDelete: true,
		...
		},
		{
			...
			args{
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(10*MAGE_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*MAGE_CF))),
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
		...
		},
		{
			...
			args{
				...
				repayer:              sdk.AccAddress(crypto.AddressHash([]byte("repayer"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(49*MAGE_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF)), sdk.NewCoin("fusd", sdk.NewInt(1000*FUSD_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))), // Exceeds repayer's balance, but not borrow amount
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
				contains:     "account can only repay up to 49000000umage",
			},
		},
		{
			...
			args{
				borrower:             sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				repayer:              sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF))),
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF)), sdk.NewCoin("fusd", sdk.NewInt(1000*FUSD_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(50*FUSD_CF))),
				repayCoins:           sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(45*FUSD_CF))),
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
		...
		},
		{
			...
			args{
				...
				repayer:              sdk.AccAddress(crypto.AddressHash([]byte("borrower"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF))),
				initialRepayerCoins:  sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF)), sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF)), sdk.NewCoin("fusd", sdk.NewInt(1000*FUSD_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(50*FUSD_CF)), sdk.NewCoin("umage", sdk.NewInt(10*MAGE_CF))), // (50*$1)+(10*$2) = $70
				repayCoins:           sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(45*FUSD_CF)), sdk.NewCoin("umage", sdk.NewInt(8*MAGE_CF))),  // (45*$1)+(8*$2) = $61
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
		...
		},
		{
			...
			args{
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(50*FUSD_CF)), sdk.NewCoin("umage", sdk.NewInt(10*MAGE_CF))), // (50*$1)+(10*$2) = $70
				repayCoins:           sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(500*FUSD_CF)), sdk.NewCoin("umage", sdk.NewInt(8*MAGE_CF))), // (500*$1)+(8*$2) = $516, or capping to borrowed amount, (50*$1)+(8*$2) = $66
			},
			errArgs{
				expectPass:   false,
				expectDelete: false,
