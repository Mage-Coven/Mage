				...
				expectedInterestSnaphots: []ExpectedBorrowInterest{
					{
						elapsedTime:  oneYearInSeconds,
						shouldBorrow: true,
						borrowCoin:   sdk.NewCoin("umage", sdk.NewInt(1*MAGE_CF)),
					},
				},
			},
			errArgs{
...
func (suite *KeeperTestSuite) TestSupplyInterest() {
	...
	testCases := []interestTest{
		...
		},
		{
			...
			args{
				user:                 sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF))),
				coinDenoms:           []string{"umage"},
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(20*MAGE_CF)), sdk.NewCoin("bnb", sdk.NewInt(20*BNB_CF))),
				interestRateModel:    normalModel,
				reserveFactor:        sdk.MustNewDecFromStr("0.05"),
				expectedInterestSnaphots: []ExpectedSupplyInterest{
					{
				...
				expectedInterestSnaphots: []ExpectedSupplyInterest{
					{
						elapsedTime:  oneMonthInSeconds,
						shouldSupply: true,
						supplyCoin:   sdk.NewCoin("umage", sdk.NewInt(20*MAGE_CF)),
					},
				},
			},
			errArgs{
		...
		},
		{
			...
			args{
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				coinDenoms:           []string{"umage"},
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(80*MAGE_CF))),
				interestRateModel:    normalModel,
				reserveFactor:        sdk.MustNewDecFromStr("0.05"),
				expectedInterestSnaphots: []ExpectedSupplyInterest{
					{
