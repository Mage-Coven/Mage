...
func (suite *KeeperTestSuite) TestBorrow() {
	type args struct {
		fusdBorrowLimit           sdk.Dec
		priceMAGE                 sdk.Dec
		loanToValueMAGE           sdk.Dec
		priceBTCB                 sdk.Dec
	...
	testCases := []borrowTest{
		{
			"valid",
			args{
				fusdBorrowLimit:           sdk.MustNewDecFromStr("100000000000"),
				priceMAGE:                 sdk.MustNewDecFromStr("5.00"),
				loanToValueMAGE:           sdk.MustNewDecFromStr("0.6"),
				...
				depositCoins:              []sdk.Coin{sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))},
				previousBorrowCoins:       sdk.NewCoins(),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(20*MAGE_CF))),
				expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(20*MAGE_CF)), sdk.NewCoin("btcb", sdk.NewInt(100*BTCB_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF)), sdk.NewCoin("xyz", sdk.NewInt(1))),
				expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1080*MAGE_CF)), sdk.NewCoin("fusd", sdk.NewInt(200*FUSD_CF)), sdk.NewCoin("busd", sdk.NewInt(100*BUSD_CF))),
			},
			errArgs{
				expectPass: true,
				contains:   "",
		...
		},
		{
			...
			args{
				...
				loanToValueBNB:            sdk.MustNewDecFromStr("0.01"),
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              []sdk.Coin{sdk.NewCoin("umage", sdk.NewInt(20*MAGE_CF))},  // 20 MAGE x $5.00 price = $100
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(61*FUSD_CF))), // 61 FUSD x $1 price = $61
		...
		},
		{
			...
			args{
				fusdBorrowLimit:           sdk.MustNewDecFromStr("100000000000"),
				priceMAGE:                 sdk.MustNewDecFromStr("2.00"),
				loanToValueMAGE:           sdk.MustNewDecFromStr("0.80"),
				priceBTCB:                 sdk.MustNewDecFromStr("10000.00"),
				loanToValueBTCB:           sdk.MustNewDecFromStr("0.10"),
				priceBNB:                  sdk.MustNewDecFromStr("0.00"),
				loanToValueBNB:            sdk.MustNewDecFromStr("0.01"),
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF)), sdk.NewCoin("btcb", sdk.NewInt(0.1*BTCB_CF))),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(180*FUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF)), sdk.NewCoin("btcb", sdk.NewInt(99.9*BTCB_CF)), sdk.NewCoin("fusd", sdk.NewInt(180*FUSD_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF)), sdk.NewCoin("xyz", sdk.NewInt(1))),
				expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1050*MAGE_CF)), sdk.NewCoin("fusd", sdk.NewInt(20*FUSD_CF)), sdk.NewCoin("btcb", sdk.NewInt(0.1*BTCB_CF)), sdk.NewCoin("busd", sdk.NewInt(100*BUSD_CF))),
			},
			errArgs{
				expectPass: true,
				contains:   "",
		...
		},
		{
			...
			args{
				...
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF)), sdk.NewCoin("btcb", sdk.NewInt(0.1*BTCB_CF))),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(181*FUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
		...
		},
		{
			...
			args{
				fusdBorrowLimit:           sdk.MustNewDecFromStr("100000000000"),
				priceMAGE:                 sdk.MustNewDecFromStr("2.00"),
				loanToValueMAGE:           sdk.MustNewDecFromStr("0.8"),
				priceBTCB:                 sdk.MustNewDecFromStr("0.00"),
				loanToValueBTCB:           sdk.MustNewDecFromStr("0.01"),
				priceBNB:                  sdk.MustNewDecFromStr("5.00"),
				loanToValueBNB:            sdk.MustNewDecFromStr("0.8"),
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("bnb", sdk.NewInt(30*BNB_CF)), sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))), // (50 MAGE x $2.00 price = $100) + (30 BNB x $5.00 price = $150) = $250
				previousBorrowCoins:       sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(99*FUSD_CF)), sdk.NewCoin("busd", sdk.NewInt(100*BUSD_CF))),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(1*FUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF)), sdk.NewCoin("btcb", sdk.NewInt(100*BTCB_CF)), sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF)), sdk.NewCoin("busd", sdk.NewInt(100*BUSD_CF)), sdk.NewCoin("bnb", sdk.NewInt(70*BNB_CF)), sdk.NewCoin("xyz", sdk.NewInt(1))),
				expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1050*MAGE_CF)), sdk.NewCoin("bnb", sdk.NewInt(30*BUSD_CF)), sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF))),
			},
			errArgs{
				expectPass: true,
				contains:   "",
		...
		},
		{
			...
			args{
				...
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("bnb", sdk.NewInt(30*BNB_CF)), sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))), // (50 MAGE x $2.00 price = $100) + (30 BNB x $5.00 price = $150) = $250
				previousBorrowCoins:       sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF)), sdk.NewCoin("busd", sdk.NewInt(100*BUSD_CF))),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(1*FUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
		...
		},
		{
			...
			args{
				...
				loanToValueBNB:            sdk.MustNewDecFromStr("0.01"),
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))),
				previousBorrowCoins:       sdk.NewCoins(),
		...
		},
		{
			...
			args{
				fusdBorrowLimit:           sdk.MustNewDecFromStr("20000000"),
				priceMAGE:                 sdk.MustNewDecFromStr("2.00"),
				loanToValueMAGE:           sdk.MustNewDecFromStr("0.8"),
				priceBTCB:                 sdk.MustNewDecFromStr("0.00"),
				loanToValueBTCB:           sdk.MustNewDecFromStr("0.01"),
				...
				loanToValueBNB:            sdk.MustNewDecFromStr("0.01"),
				borrower:                  sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:              sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				previousBorrowCoins:       sdk.NewCoins(),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(25*FUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
		...
		},
		{
			...
			args{
				...
				depositCoins:              sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				previousBorrowCoins:       sdk.NewCoins(),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(5*FUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
		...
		},
		{
			...
			args{
				...
				depositCoins:              sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(50*MAGE_CF))),
				previousBorrowCoins:       sdk.NewCoins(),
				borrowCoins:               sdk.NewCoins(sdk.NewCoin("fusd", sdk.NewInt(5*FUSD_CF)), sdk.NewCoin("umage", sdk.NewInt(2*FUSD_CF))),
				expectedAccountBalance:    sdk.NewCoins(),
				expectedModAccountBalance: sdk.NewCoins(),
			},
			errArgs{
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			authGS := app.NewFundedGenStateWithCoins(
				...
				[]sdk.Coins{
					sdk.NewCoins(
						sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF)),
			...
			hardGS := types.NewGenesisState(types.NewParams(
				types.MoneyMarkets{
					types.NewMoneyMarket("fusd", types.NewBorrowLimit(true, tc.args.fusdBorrowLimit, sdk.MustNewDecFromStr("1")), "fusd:usd", sdk.NewInt(FUSD_CF), types.NewInterestRateModel(sdk.MustNewDecFromStr("0.05"), sdk.MustNewDecFromStr("2"), sdk.MustNewDecFromStr("0.8"), sdk.MustNewDecFromStr("10")), sdk.MustNewDecFromStr("0.05"), sdk.ZeroDec()),
					...
					types.NewMoneyMarket("umage", types.NewBorrowLimit(false, sdk.NewDec(100000000*MAGE_CF), tc.args.loanToValueMAGE), "mage:usd", sdk.NewInt(MAGE_CF), types.NewInterestRateModel(sdk.MustNewDecFromStr("0.05"), sdk.MustNewDecFromStr("2"), sdk.MustNewDecFromStr("0.8"), sdk.MustNewDecFromStr("10")), sdk.MustNewDecFromStr("0.05"), sdk.ZeroDec()),
			...
			hardMaccCoins := sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF)),
				sdk.NewCoin("fusd", sdk.NewInt(200*FUSD_CF)), sdk.NewCoin("busd", sdk.NewInt(100*BUSD_CF)))
...
func (suite *KeeperTestSuite) TestValidateBorrow() {
	...
	initialBorrowerBalance := sdk.NewCoins(
		sdk.NewCoin("umage", sdk.NewInt(1000*MAGE_CF)),
		sdk.NewCoin("fusd", sdk.NewInt(1000*MAGE_CF)),
	)
		...
		types.NewParams(
			types.MoneyMarkets{
				types.NewMoneyMarket("fusd",
					types.NewBorrowLimit(false, sdk.NewDec(100000000*FUSD_CF), sdk.MustNewDecFromStr("1")), // Borrow Limit
					"fusd:usd",                     // Market ID
					sdk.NewInt(FUSD_CF),            // Conversion Factor
	...
	depositCoins := sdk.NewCoins(
		sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF)),
		sdk.NewCoin("fusd", sdk.NewInt(100*FUSD_CF)),
	)
	err = suite.keeper.Deposit(suite.ctx, borrower, depositCoins)
	suite.Require().NoError(err)

	initialBorrowCoins := sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(70*MAGE_CF)))
	...
	repayCoins := sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(100*MAGE_CF))) // repay everything including accumulated interest
	...
	err = suite.keeper.Borrow(
		suite.ctx,
		borrower,
		sdk.NewCoins(sdk.NewCoin("umage", availableToBorrow.AmountOf("umage").Add(sdk.OneInt()))),
	)
	suite.Require().Error(err)
	...
	err = suite.keeper.Borrow(
		suite.ctx,
		borrower,
		sdk.NewCoins(sdk.NewCoin("umage", availableToBorrow.AmountOf("umage"))),
	)
	suite.Require().NoError(err)
}
