...
// source: mage/community/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryBalanceRequest)(nil), "mage.community.v1beta1.QueryBalanceRequest")
	proto.RegisterType((*QueryBalanceResponse)(nil), "mage.community.v1beta1.QueryBalanceResponse")
}

func init() {
	proto.RegisterFile("mage/community/v1beta1/query.proto", fileDescriptor_f236f06c43149273)
}
...
func (c *queryClient) Balance(ctx context.Context, in *QueryBalanceRequest, opts ...grpc.CallOption) (*QueryBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.community.v1beta1.Query/Balance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.community.v1beta1.Query/Balance",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mage.community.v1beta1.Query",
	...
	Metadata: "mage/community/v1beta1/query.proto",
}
