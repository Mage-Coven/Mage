...
// source: mage/evmutil/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgConvertCoinToERC20)(nil), "mage.evmutil.v1beta1.MsgConvertCoinToERC20")
	proto.RegisterType((*MsgConvertCoinToERC20Response)(nil), "mage.evmutil.v1beta1.MsgConvertCoinToERC20Response")
	proto.RegisterType((*MsgConvertERC20ToCoin)(nil), "mage.evmutil.v1beta1.MsgConvertERC20ToCoin")
	proto.RegisterType((*MsgConvertERC20ToCoinResponse)(nil), "mage.evmutil.v1beta1.MsgConvertERC20ToCoinResponse")
}

func init() { proto.RegisterFile("mage/evmutil/v1beta1/tx.proto", fileDescriptor_6e82783c6c58f89c) }
...
func (c *msgClient) ConvertCoinToERC20(ctx context.Context, in *MsgConvertCoinToERC20, opts ...grpc.CallOption) (*MsgConvertCoinToERC20Response, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.evmutil.v1beta1.Msg/ConvertCoinToERC20", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ConvertERC20ToCoin(ctx context.Context, in *MsgConvertERC20ToCoin, opts ...grpc.CallOption) (*MsgConvertERC20ToCoinResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mage.evmutil.v1beta1.Msg/ConvertERC20ToCoin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ConvertCoinToERC20_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.evmutil.v1beta1.Msg/ConvertCoinToERC20",
	}
...
func _Msg_ConvertERC20ToCoin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mage.evmutil.v1beta1.Msg/ConvertERC20ToCoin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mage.evmutil.v1beta1.Msg",
	...
	Metadata: "mage/evmutil/v1beta1/tx.proto",
}
