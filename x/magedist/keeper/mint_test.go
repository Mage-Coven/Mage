...
import (
	...
	"github.com/mage-coven/mage/x/magedist/types"
)
	...
	testCases := []test{
		{
			...
			args{
				...
				partnerRewards:      types.PartnerRewards{types.NewPartnerReward(addrs[2], sdk.NewCoin("umage", sdk.NewInt(2)))},
				expectedFinalSupply: sdk.NewCoin(types.GovDenom, sdk.NewInt(1102500000000)),
				expectedBalances: balances{
					balance{addrs[1], sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(52436928000)))},
					balance{addrs[2], sdk.NewCoins(sdk.NewCoin("umage", sdk.NewInt(63072000)))},
				},
				marginOfError: sdk.MustNewDecFromStr("0.0001"),
			},
			errArgs{
